...
urlpatterns = [
    ...
    url(r'^Update_Raw_Material/(?P<component_id>\d+)/$', views.update_quantity_raw_material),
    ...
    url(r'^create_component/(?P<final_product_id>\d+)/$', views.create_component),
    url(r'^delete_component/(?P<component_id>\d+)/(?P<final_product_id>\d+)/$', views.delete_component , name = 'delete_component' ),

    url(r'^create_product/', views.create_product),  
    url(r'^delete_Final_Product/(?P<final_product_id>\d+)/$', views.delete_Final_Product , name='delete_Final_Product'),
